...
a=Map("ss_server",translate("ShadowSocks Server Config"),translate("Set up a Shadowsocks server on your router"))
a.template="ss_server/index"
t=a:section(TypedSection,"global",translate("Running Status"))
t.anonymous=true
e=t:option(DummyValue,"server_status",translate("Current Status"))
e.template="ss_server/dvalue"
...
e.rmempty=false
e=t:option(ListValue,"udp_relay",translate("UDP_Relay"))
for a,t in ipairs(o)do e:value(t)end
e.rmempty=false
